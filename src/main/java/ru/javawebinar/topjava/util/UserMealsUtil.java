...
//        mealsTo.forEach(System.out::println);
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        List<UserMeal> sortedMeals = new ArrayList<>();
        ...
        sortedMeals.sort(Comparator.comparing(UserMeal::getDateTime));

        for (UserMeal sortedMeal : sortedMeals) {
            filteredMeals.add(new UserMealWithExcess(sortedMeal.getDateTime(), sortedMeal.getDescription(), sortedMeal.getCalories(),
